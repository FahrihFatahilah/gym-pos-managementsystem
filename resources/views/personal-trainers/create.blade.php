...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('personal-trainers.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('specialization') is-invalid @enderror" 
                                  ...
                                  placeholder="Contoh: Weight Loss, Muscle Building, Cardio Training, dll.">{{ old('specialization') }}</textarea>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('personal-trainers.index') }}" class="btn btn-secondary">
