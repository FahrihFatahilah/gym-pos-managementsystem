                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <form action="{{ route('pt-members.use-session', $member) }}" method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-outline-warning" onclick="return confirm('Gunakan 1 sesi?')" title="Gunakan Sesi">
                                            ...
                                            <form action="{{ route('pt-members.destroy', $member) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-outline-danger" onclick="return confirm('Hapus member ini?')" title="Hapus">
